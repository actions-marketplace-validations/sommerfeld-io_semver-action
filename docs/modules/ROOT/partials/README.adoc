...
|`src/main/go/Dockerfile` |The Dockerfile which bundles the Go applcation. The Go application serves as the core logic for managing and handling all tasks related to semantic versions. 
|===
