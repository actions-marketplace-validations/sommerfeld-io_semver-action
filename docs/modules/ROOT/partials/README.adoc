...
|`src/main/action/Dockerfile` |The Dockerfile used for the Github Action. This image is not pblished to DockerHub
|`src/main/semver-app/Dockerfile` |The Dockerfile which bundles the Go applcation. The Go application serves as the core logic for managing and handling all tasks related to semantic versions. 
|===
